...
### 7.1 Wrong credentials are filled-in
...
### 7.2 chromeIPass stopped working

#### 7.2.1 First check the running versions of your software
...
#### 7.2.2 Check the background page console for error messages
...
#### 7.2.3 Check the inline page console for error messages
