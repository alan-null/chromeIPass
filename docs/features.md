...
- contains a [password generator](functionality#32-password-generator) which works together with KeePass
...
- accessible via [shortcuts](functionality#314-shortcuts) (Ctrl+Shift+U and Ctrl+Shift+P)
